			...
			<div className="w-full max-w-md md:max-w-lg lg:max-w-xl flex flex-col justify-between h-screen py-4">
				...
				<div className="flex flex-col justify-center md:justify-center xl:justify-start flex-1 pt-0 md:pt-0 xl:pt-6">
					...
					<div className="text-center mb-4 md:mb-3">
						<div className="w-20 h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 mx-auto mb-3 md:mb-2 rounded-2xl flex items-center justify-center relative overflow-hidden" style={{
							background: '#faf7f0'
						}}>
							{/* 波模様の装飾 */}
				...
				{/* Legal Links - Bottom */}
				<div className="text-center text-xs md:text-sm text-gray-500 pb-8 md:pb-8">
