...
export default function LoginPage() {
	return (
		<div className="h-screen bg-stone-50 flex items-center justify-center px-4 overflow-hidden">
				...
				<div className="flex flex-col justify-between flex-1">
					...
					<div className="pt-20 md:pt-0 xl:pt-6">
						...
						<div className="text-center mb-4 md:mb-3">
							<div
								className="w-20 h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 mx-auto mb-3 md:mb-2 rounded-2xl flex items-center justify-center relative overflow-hidden"
								style={{
									background: "#faf7f0",
								}}
							>
								...
								<span className="text-lg md:text-xl lg:text-2xl font-bold text-gray-800 relative z-10">
									SHUN
								</span>
							</div>
					...
					<div className="text-center text-xs md:text-sm text-gray-500 pt-20 md:pt-8">
